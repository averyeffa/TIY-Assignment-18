...
tabsContainerEl.addEventListener('click', function (evt) {
	...
	if (clickedTabEl.dataset.route === 'home') {
		pageContentEl.innerHTML = homeHtml;
	}
	...
	_jquery2.default.getJSON('http://apis.is/concerts').then(function (concertsRes) {
		...
		forEach(concertsObj, function (concertsEl, index, theArray) {
			...
			if (clickedTabEl.dataset.route === 'concerts') {
				pageContentEl.innerHTML = concertsHtml;
			}
		});
	});
	...
	_jquery2.default.getJSON('http://apis.is/rides/samferda-drivers/').then(function (carpoolsRes) {
		...
		forEach(carpoolsObj, function (carpoolsEl, index, theArray) {
			...
			if (clickedTabEl.dataset.route === 'carpools') {
				pageContentEl.innerHTML = carpoolsHtml;
			}
		});
	});
	...
	_jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals').then(function (arrivalsRes) {
	...
	_jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals').then(function (departuresRes) {
